...
from cnn.model.builder import build_model
...
def create_model(input_dim, output_dim, trg_field):
    return build_model(input_dim, output_dim, trg_field, device)
